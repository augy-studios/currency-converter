/* ─── Icons ───
   Inline SVG only, no emoji and no icon fonts. Referenced in markup as
   data-icon="name" and hydrated by hydrateIcons() in ui.js. Icons inherit
   their colour through currentColor, so never hardcode fill or stroke. */
